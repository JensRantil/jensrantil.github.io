...
description = "A list of some tools that can be used to foster innovation within tech organisations."
tags = ["organisation"]
+++
As a tech organisation, how do you deal with making sure you innovate? In my
 ...
 * **"There is no time for that."** Teams working under urgent conditions might
   constantly downpriorise trying out new things.
 ...
 * The **team might lack psychological safety** to allow for ideas to bubble
   up.
 * **Planning for innovation kills innovation.** This is a big one for me.
   Personally, I just don't feel as creative if I need to explicitly ask for
   permission and plan for innovation. For me I am the most innovative when I
   sometimes stumble across a small problem and immeditately spend time finding
   a solution.
...
## The "three bucket model" for teams

I've previously written about the ["three buckets model"][team-bucket-model].
Explicitly asking about "Team initiatives" help the team to start thinking
about improvements they can make. It also signals that innovation is _not_
someone elses job, but everyone's job - including engineers'.
...
come together to build something rapidly and in a collaborative manner. People
form teams of ~2-5 people and work on a project of their choosing. The
hackathons I've taken part in lasted for at least two days. Usually the
hackathon ends with an event where all the hack projects built are presented.
The only rule is that all teams need to present what they built so far during
the hackathon at the end.

An optional additional rule you can have for a hackathon is that everyone must
team up with at least one person from another team. I have seen it first hand
...
people take on. I have seen some remarkable things come out of hackathon - and
...
can have a negative effect on the outcome. You _can_ have themed hackathons,
though. They are useful if you would like to innovate on a specific topic.

Hackathons can also be had across an entire company. This is really cool!
Imagine all the helping hand an engineer could give the legal, HR or marketing
department. I have heard of lots of process improvements; Create a website for
hiring? Help legal department search through contracts faster? Configure Google
Analytics to help the marketing department understand visitors better?

## Hack days

Hack days are micro hackathons, but on a smaller team basis on a regular
cadence. Usually a hackday happens at least once per month, but I used to work
in a team where we had one every two weeks. Similarly to hackdays, the only
...
larger ritual of a team. I have heard of teams doing a hackday at the beginning
...
learnings with the rest of the organisation? Or maybe a team discovered a new
...
Or someone did some research around testing frameworks and wanted to share
their learnings?
...
room (Slack channel, etc.) can be a surpringly simple way to increase knowledge
sharing.
...
Finally, removing rigid processes can be a great way to create a innovation.
If you [prefer toolkits over rigid processes][toolkits-not-processes] you
increase the likelihood of engineers naturally coming up with better processes
or find better tools to do the work they need to do. Remember that it is
usually the builders (your engineers) who knows which tools and processes they
