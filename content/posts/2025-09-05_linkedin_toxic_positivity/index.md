...
In Swedish, there is the expression "Axelklapparklubben" which literally translates to "The Back-patting club". It's a mutual admiration society, an expression that is used to describe a setting where every participant is only telling each other how great they are.
