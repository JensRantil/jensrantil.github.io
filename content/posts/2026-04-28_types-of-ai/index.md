...
A success metric for an AI product interface could be _usage by end users_. But ultimately, that does not say anything about the outcome. A better success metric is if users can use the AI/LLM interface to succesfully and quickly perform the task at hand.
